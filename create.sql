...
create table Trilha (id  bigserial not null, anotacoes varchar(255), apelido varchar(255), nome varchar(255), ocupacao varchar(255) not null, satisfacao varchar(255), empresa_id_trilha int8 not null, primary key (id));
...
create table ModuloTrabalhador (
    ...
    modulo_trabalhador_id int8, primary key (id));
...
alter table ModuloTrabalhador add constraint FK3sfiuq5vvetccd75ulce8v8ix foreign key (trabalhador_id) references Trabalhador;
