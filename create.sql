...
create table ModuloTrabalhador (id  bigserial not null, anotacao varchar(255), avaliacao varchar(255), cpf varchar(255), funcao varchar(255) not null, setor varchar(255) not null, modulo_mod_trab_id int8 not null, modulo_trabalhador_id int8, primary key (id));
...
alter table Usuario_perfis add constraint FKbl3tsfnts24te4um6sam8y0in foreign key (Usuario_id) references Usuario on delete cascade;
